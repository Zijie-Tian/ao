...
def get_problem(m, n, k, group_size=128, nbits=2):
    ...
    return activations, weight, packed_qweight, fp32_requant_activations, dequant_weight, m, n, k, group_size
    
def benchmark(m : int, k : int, n : int):
    #> Here use FP32, because we on CPU !
    fp32_act, fp32_weight, int8_packed_weight, fp32_requant_act, fp32_requant_weight, m, n, k, group_size = get_problem(m, n, k)
    ...
    real_ref = fp32_act @ fp32_weight.T
    ...
    algo_sqnr = compute_error(results, real_ref)
