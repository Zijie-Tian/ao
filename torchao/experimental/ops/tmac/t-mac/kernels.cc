...
extern "C"
 ...
 int32_t qgemm_lut_t1_int8_m8192_k4096_n1_b2(void* A, void* LUT, void* Scales, void* LUT_Scales, void* LUT_Biases, void* C) {
  ...
  void* qgemm_lut_t1_int8_m8192_k4096_n1_b2_A_shape = (NULL);
  void* qgemm_lut_t1_int8_m8192_k4096_n1_b2_A_strides = (NULL);
  int32_t dev_id = (0);
  void* A_1 = (A);
  void* qgemm_lut_t1_int8_m8192_k4096_n1_b2_LUT_shape = (NULL);
  void* qgemm_lut_t1_int8_m8192_k4096_n1_b2_LUT_strides = (NULL);
  void* LUT_1 = (LUT);
  void* qgemm_lut_t1_int8_m8192_k4096_n1_b2_Scales_shape = (NULL);
  void* qgemm_lut_t1_int8_m8192_k4096_n1_b2_Scales_strides = (NULL);
  void* Scales_1 = (Scales);
  void* qgemm_lut_t1_int8_m8192_k4096_n1_b2_LUT_Scales_shape = (NULL);
  void* qgemm_lut_t1_int8_m8192_k4096_n1_b2_LUT_Scales_strides = (NULL);
  void* LUT_Scales_1 = (LUT_Scales);
  void* qgemm_lut_t1_int8_m8192_k4096_n1_b2_LUT_Biases_shape = (NULL);
  void* qgemm_lut_t1_int8_m8192_k4096_n1_b2_LUT_Biases_strides = (NULL);
  void* LUT_Biases_1 = (LUT_Biases);
  void* qgemm_lut_t1_int8_m8192_k4096_n1_b2_C_shape = (NULL);
  void* qgemm_lut_t1_int8_m8192_k4096_n1_b2_C_strides = (NULL);
  void* C_1 = (C);
  if (!(qgemm_lut_t1_int8_m8192_k4096_n1_b2_A_strides == NULL)) {
  }
  if (!(qgemm_lut_t1_int8_m8192_k4096_n1_b2_LUT_strides == NULL)) {
  }
  if (!(qgemm_lut_t1_int8_m8192_k4096_n1_b2_Scales_strides == NULL)) {
  }
  if (!(qgemm_lut_t1_int8_m8192_k4096_n1_b2_LUT_Scales_strides == NULL)) {
  }
  if (!(qgemm_lut_t1_int8_m8192_k4096_n1_b2_LUT_Biases_strides == NULL)) {
  }
  if (!(qgemm_lut_t1_int8_m8192_k4096_n1_b2_C_strides == NULL)) {
  }
  ...
  for (int32_t m_outer = 0; m_outer < 8; ++m_outer) {
    tbl_float_reset(1024, (&(((half*)CBits)[0])));
    for (int32_t k_outer = 0; k_outer < 64; ++k_outer) {
      tbl_g4_int8_float_update_strue_k16_b2_ak16_fafalse_zfalse_osfalse(1024, (&(((half*)CBits)[0])), (&(((int8_t*)LUT_1)[(k_outer * 256)])), (&(((uint8_t*)A_1)[((m_outer * 524288) + (k_outer * 8192))])), (&(((half*)Scales_1)[((m_outer * 16384) + ((k_outer >> 1) * 512))])), (&(((half*)LUT_Scales_1)[k_outer])), (&(((half*)LUT_Biases_1)[k_outer])));
    }
    ...
    for (int32_t m_inner_outer = 0; m_inner_outer < 16; ++m_inner_outer) {
      ...
      int32_t cse_var_3 = ((m_outer * 512) + cse_var_4);
      ((half*)C_1)[cse_var_3] = ((half*)C_global)[cse_var_4];
      ((half*)C_1)[(cse_var_3 + 1)] = ((half*)C_global)[(cse_var_4 + 1)];
      ((half*)C_1)[(cse_var_3 + 2)] = ((half*)C_global)[(cse_var_4 + 2)];
      ((half*)C_1)[(cse_var_3 + 3)] = ((half*)C_global)[(cse_var_4 + 3)];
      ((half*)C_1)[(cse_var_3 + 4)] = ((half*)C_global)[(cse_var_4 + 4)];
      ((half*)C_1)[(cse_var_3 + 5)] = ((half*)C_global)[(cse_var_4 + 5)];
      ((half*)C_1)[(cse_var_3 + 6)] = ((half*)C_global)[(cse_var_4 + 6)];
      ((half*)C_1)[(cse_var_3 + 7)] = ((half*)C_global)[(cse_var_4 + 7)];
      ((half*)C_1)[(cse_var_3 + 8)] = ((half*)C_global)[(cse_var_4 + 8)];
      ((half*)C_1)[(cse_var_3 + 9)] = ((half*)C_global)[(cse_var_4 + 9)];
      ((half*)C_1)[(cse_var_3 + 10)] = ((half*)C_global)[(cse_var_4 + 10)];
      ((half*)C_1)[(cse_var_3 + 11)] = ((half*)C_global)[(cse_var_4 + 11)];
      ((half*)C_1)[(cse_var_3 + 12)] = ((half*)C_global)[(cse_var_4 + 12)];
      ((half*)C_1)[(cse_var_3 + 13)] = ((half*)C_global)[(cse_var_4 + 13)];
      ((half*)C_1)[(cse_var_3 + 14)] = ((half*)C_global)[(cse_var_4 + 14)];
      ((half*)C_1)[(cse_var_3 + 15)] = ((half*)C_global)[(cse_var_4 + 15)];
      ((half*)C_1)[(cse_var_3 + 16)] = ((half*)C_global)[(cse_var_4 + 16)];
      ((half*)C_1)[(cse_var_3 + 17)] = ((half*)C_global)[(cse_var_4 + 17)];
      ((half*)C_1)[(cse_var_3 + 18)] = ((half*)C_global)[(cse_var_4 + 18)];
      ((half*)C_1)[(cse_var_3 + 19)] = ((half*)C_global)[(cse_var_4 + 19)];
      ((half*)C_1)[(cse_var_3 + 20)] = ((half*)C_global)[(cse_var_4 + 20)];
      ((half*)C_1)[(cse_var_3 + 21)] = ((half*)C_global)[(cse_var_4 + 21)];
      ((half*)C_1)[(cse_var_3 + 22)] = ((half*)C_global)[(cse_var_4 + 22)];
      ((half*)C_1)[(cse_var_3 + 23)] = ((half*)C_global)[(cse_var_4 + 23)];
      ((half*)C_1)[(cse_var_3 + 24)] = ((half*)C_global)[(cse_var_4 + 24)];
      ((half*)C_1)[(cse_var_3 + 25)] = ((half*)C_global)[(cse_var_4 + 25)];
      ((half*)C_1)[(cse_var_3 + 26)] = ((half*)C_global)[(cse_var_4 + 26)];
      ((half*)C_1)[(cse_var_3 + 27)] = ((half*)C_global)[(cse_var_4 + 27)];
      ((half*)C_1)[(cse_var_3 + 28)] = ((half*)C_global)[(cse_var_4 + 28)];
      ((half*)C_1)[(cse_var_3 + 29)] = ((half*)C_global)[(cse_var_4 + 29)];
      ((half*)C_1)[(cse_var_3 + 30)] = ((half*)C_global)[(cse_var_4 + 30)];
      ((half*)C_1)[(cse_var_3 + 31)] = ((half*)C_global)[(cse_var_4 + 31)];
    }
  }
  if (0 != 0) {
    return -1;
